...
var PRESETS = map[string]PresetLocations{
	...
	"sri lanka":    PresetLocations{"sri%2Blanka", "balangoda", "ratnapura", "colombo", "moratuwa", "negombo", "galle", "jaffna", "kelaniya", "ambalangoda", "panadura", "wadduwa", "moronthuduwa", "minuwangoda","kegalle","nuwraeliya","kirulapone","pitigala","alawwa","kurunegala","polgahawela","kuruwita","nugegoda","kalutara","horana","anuradhapura", "nivithigala", "kurunegala"},
